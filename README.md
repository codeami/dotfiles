...
- `home/AGENTS.md` is the shared agent policy, and `home.nix` installs it as `~/.claude/CLAUDE.md`, `~/.codex/AGENTS.md` and `~/.config/opencode/AGENTS.md` - one file, three agents.
